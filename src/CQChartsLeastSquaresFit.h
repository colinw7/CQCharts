#ifndef CQChartsLeastSquaresFit_H
#define CQChartsLeastSquaresFit_H

#include <CLeastSquaresFit.h>

class CQChartsLeastSquaresFit {
 public:
  CQChartsLeastSquaresFit() { }
  ...
  void calc(const std::vector<QPointF> &points, int order) {
    int np = points.size();
