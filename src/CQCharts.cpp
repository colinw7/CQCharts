...
#define addChartsWidgetFactoryNoArgsT(N) \
CQWidgetFactoryMgrInst->addWidgetFactoryNoArgsT<CQCharts##N>("CQCharts:" #N);

#define addChartsComplexWidgetFactoryT(N) \
CQWidgetFactoryMgrInst->addWidgetFactoryT<CQCharts##N>("CQCharts:" #N)->setComplex();

#define addChartsComplexWidgetFactoryNoArgsT(N) \
CQWidgetFactoryMgrInst->addWidgetFactoryNoArgsT<CQCharts##N>("CQCharts:" #N)->setComplex();

#define addColorsWidgetFactoryT(N) \
CQWidgetFactoryMgrInst->addWidgetFactoryT<CQColors##N>("CQColors:" #N);

#define addCQWidgetFactoryT(N) \
CQWidgetFactoryMgrInst->addWidgetFactoryT<CQ##N>("CQ:" #N);

#define addCQComplexWidgetFactoryT(N) \
CQWidgetFactoryMgrInst->addWidgetFactoryT<CQ##N>("CQ:" #N)->setComplex();
...
CQCharts()
{
  ...
  metaObj_ = new CQChartsPropertyMeta(this);
}
...
init()
{
  ...
  // add column types
  auto *columnTypeMgr = this->columnTypeMgr();
...
#define CQChartsAddPropertyType(T, N) \
propertyNames_.insert(N); \
CQPropertyViewMgrInst->addTypeT<CQCharts##T##PropertyViewType>(N);

    // add property types (and editors)
    CQChartsAddPropertyType(Alpha                 , "CQChartsAlpha"                 );
    CQChartsAddPropertyType(Angle                 , "CQChartsAngle"                 );
    CQChartsAddPropertyType(ArrowData             , "CQChartsArrowData"             );
    CQChartsAddPropertyType(AxisSide              , "CQChartsAxisSide"              );
    CQChartsAddPropertyType(AxisTickLabelPlacement, "CQChartsAxisTickLabelPlacement");
    CQChartsAddPropertyType(AxisValueType         , "CQChartsAxisValueType"         );
    CQChartsAddPropertyType(BoxData               , "CQChartsBoxData"               );
    CQChartsAddPropertyType(Color                 , "CQChartsColor"                 );
    CQChartsAddPropertyType(Column                , "CQChartsColumn"                );
    CQChartsAddPropertyType(Columns               , "CQChartsColumns"               );
    CQChartsAddPropertyType(ColumnNum             , "CQChartsColumnNum"             );
    CQChartsAddPropertyType(FillData              , "CQChartsFillData"              );
    CQChartsAddPropertyType(FillPattern           , "CQChartsFillPattern"           );
    CQChartsAddPropertyType(FillUnderPos          , "CQChartsFillUnderPos"          );
    CQChartsAddPropertyType(FillUnderSide         , "CQChartsFillUnderSide"         );
    CQChartsAddPropertyType(Font                  , "CQChartsFont"                  );
    CQChartsAddPropertyType(Image                 , "CQChartsImage"                 );
    CQChartsAddPropertyType(KeyLocation           , "CQChartsKeyLocation"           );
    CQChartsAddPropertyType(KeyPressBehavior      , "CQChartsKeyPressBehavior"      );
    CQChartsAddPropertyType(Length                , "CQChartsLength"                );
    CQChartsAddPropertyType(LineCap               , "CQChartsLineCap"               );
    CQChartsAddPropertyType(LineDash              , "CQChartsLineDash"              );
    CQChartsAddPropertyType(LineData              , "CQChartsLineData"              );
    CQChartsAddPropertyType(LineJoin              , "CQChartsLineJoin"              );
    CQChartsAddPropertyType(Margin                , "CQChartsMargin"                );
    CQChartsAddPropertyType(ModelColumn           , "CQChartsModelColumn"           );
//  CQChartsAddPropertyType(ModelInd              , "CQChartsModelInd"              );
//  CQChartsAddPropertyType(ObjRef                , "CQChartsObjRef"                );
//  CQChartsAddPropertyType(ObjRefPos             , "CQChartsObjRefPos"             );
    CQChartsAddPropertyType(PaletteName           , "CQChartsPaletteName"           );
//  CQChartsAddPropertyType(Points                , "CQChartsPoints"                );
    CQChartsAddPropertyType(Polygon               , "CQChartsPolygon"               );
    CQChartsAddPropertyType(Position              , "CQChartsPosition"              );
//  CQChartsAddPropertyType(Reals                 , "CQChartsReals"                 );
    CQChartsAddPropertyType(Rect                  , "CQChartsRect"                  );
    CQChartsAddPropertyType(ShapeData             , "CQChartsShapeData"             );
    CQChartsAddPropertyType(ShapeType             , "CQChartsShapeType"             );
    CQChartsAddPropertyType(Sides                 , "CQChartsSides"                 );
    CQChartsAddPropertyType(StrokeData            , "CQChartsStrokeData"            );
    CQChartsAddPropertyType(SymbolData            , "CQChartsSymbolData"            );
    CQChartsAddPropertyType(Symbol                , "CQChartsSymbol"                );
//  CQChartsAddPropertyType(SymbolSet             , "CQChartsSymbolSet"             );
//  CQChartsAddPropertyType(SymbolType            , "CQChartsSymbolType"            );
    CQChartsAddPropertyType(TextBoxData           , "CQChartsTextBoxData"           );
    CQChartsAddPropertyType(TextData              , "CQChartsTextData"              );
    CQChartsAddPropertyType(TitleLocation         , "CQChartsTitleLocation"         );
    CQChartsAddPropertyType(Units                 , "CQChartsUnits"                 );
    CQChartsAddPropertyType(ValueList             , "CQChartsValueList"             );

    CQChartsAddPropertyType(GeomBBox , "CQChartsGeom::BBox" );
    CQChartsAddPropertyType(GeomPoint, "CQChartsGeom::Point");

    CQChartsAddPropertyType(OptBool    , "CQChartsOptBool"    );
    CQChartsAddPropertyType(OptInt     , "CQChartsOptInt"     );
    CQChartsAddPropertyType(OptReal    , "CQChartsOptReal"    );
    CQChartsAddPropertyType(OptString  , "CQChartsOptString"  );
    CQChartsAddPropertyType(OptLength  , "CQChartsOptLength"  );
    CQChartsAddPropertyType(OptPosition, "CQChartsOptPosition");
    CQChartsAddPropertyType(OptRect    , "CQChartsOptRect"    );
    ...
    // controls
    addChartsWidgetFactoryT(PlotControlFrame);
    addChartsWidgetFactoryT(PlotRealControl);
    addChartsWidgetFactoryT(PlotIntControl);
    addChartsWidgetFactoryT(PlotTimeControl);
    addChartsWidgetFactoryT(PlotValueControl);

    // model view
    addChartsComplexWidgetFactoryNoArgsT(ModelViewHolder);
    addChartsComplexWidgetFactoryNoArgsT(ModelDetailsTable);
    addChartsComplexWidgetFactoryNoArgsT(ModelDetailsWidget);
    addChartsComplexWidgetFactoryNoArgsT(ModelTableControl);
    addChartsComplexWidgetFactoryNoArgsT(ModelTable);
    addChartsComplexWidgetFactoryNoArgsT(ModelDataWidget);

    addChartsWidgetFactoryNoArgsT(ModelColumnDataControl);
    addChartsComplexWidgetFactoryNoArgsT(ModelExprControl);
    addChartsComplexWidgetFactoryNoArgsT(ModelControl);
#if 0
    addChartsWidgetFactoryNoArgsT(ModelFoldControl);
#endif

    // properties
    addChartsWidgetFactoryNoArgsT(GlobalPropertiesWidget);
    addChartsWidgetFactoryNoArgsT(ViewPropertiesControl);
    addChartsWidgetFactoryNoArgsT(ViewPropertiesWidget);
    addChartsWidgetFactoryNoArgsT(PlotPropertiesControl);
    addChartsWidgetFactoryNoArgsT(PlotPropertiesWidget);

    // plots
    addChartsComplexWidgetFactoryNoArgsT(PlotTableControl);
    addChartsComplexWidgetFactoryNoArgsT(PlotTable);

    // annotations
    addChartsComplexWidgetFactoryNoArgsT(AnnotationsControl);
    addChartsComplexWidgetFactoryNoArgsT(ViewAnnotationsControl);
    addChartsComplexWidgetFactoryNoArgsT(PlotAnnotationsControl);
    addChartsComplexWidgetFactoryNoArgsT(ViewAnnotationsTable);
    addChartsComplexWidgetFactoryNoArgsT(PlotAnnotationsTable);

    // colors
    addChartsComplexWidgetFactoryT(PaletteCanvas);
    addChartsComplexWidgetFactoryT(PaletteControl);
    addChartsComplexWidgetFactoryT(InterfaceControl);

    // misc
    addChartsWidgetFactoryNoArgsT(ModelChooser);
    addChartsComplexWidgetFactoryNoArgsT(ModelFilterControl);
    addChartsComplexWidgetFactoryNoArgsT(ModelFlattenControl);
    addChartsComplexWidgetFactoryNoArgsT(ModelFoldControl);

    // other edits (all ?)
    addChartsWidgetFactoryT(AlphaEdit);
    addChartsWidgetFactoryT(AngleEdit);
    addChartsWidgetFactoryT(ColorEdit);
    addChartsComplexWidgetFactoryT(ColumnEdit);
    addChartsComplexWidgetFactoryT(ColumnsEdit);
    addChartsComplexWidgetFactoryT(FontEdit);
    addChartsWidgetFactoryT(ImageEdit);
...
//  addChartsWidgetFactoryT(ModelIndEdit);
    ...
    addChartsWidgetFactoryT(UnitsEdit);

    // symbols
    addChartsWidgetFactoryT(SymbolTypeEdit);
    addChartsWidgetFactoryT(SymbolSetEdit);
    addChartsComplexWidgetFactoryT(SymbolEdit);

    addChartsComplexWidgetFactoryNoArgsT(SymbolSetsList);
    addChartsComplexWidgetFactoryNoArgsT(SymbolsList);
    ...
    // colors
    addColorsWidgetFactoryT(EditList);

    // basic
    addCQWidgetFactoryT(IntRangeSlider);
    addCQWidgetFactoryT(DoubleRangeSlider);
    addCQWidgetFactoryT(TimeRangeSlider);

    addCQWidgetFactoryT(AlignEdit);
    addCQWidgetFactoryT(CheckBox);
    addCQWidgetFactoryT(ColorEdit);
    addCQWidgetFactoryT(CustomCombo);
    addCQWidgetFactoryT(DragLabel);
    addCQWidgetFactoryT(Filename);
    addCQWidgetFactoryT(FontEdit);
    addCQWidgetFactoryT(GroupBox);
    addCQWidgetFactoryT(IconCombo);
    addCQWidgetFactoryT(IntegerSpin);
    addCQWidgetFactoryT(RadioButtons);
    addCQWidgetFactoryT(RealSpin);
    addCQWidgetFactoryT(Switch);
    addCQComplexWidgetFactoryT(TableWidget);
    addCQWidgetFactoryT(TabWidget);
    addCQWidgetFactoryT(WinWidget);
  }
...
void
CQCharts::
getPropertyTypeNames(QStringList &names) const
{
  for (const auto &s : propertyNames_)
    names << s;
}
...
QStringList
CQCharts::
getMetaTypeNames() const
{
  return metaObj_->names();
}

QString
CQCharts::
getPropertyTypeData(const QString &name) const
{
  QString name1 = name;
  if      (name1.left(14) == "CQChartsGeom::")
    name1 = "Geom" + name1.mid(14);
  else if (name1.left(8) == "CQCharts")
    name1 = name1.mid(8);

  QString value;
  if (! metaObj_->getTypeStr(name1, value))
    return "<null>";
...
void
CQCharts::
setPropertyTypeData(const QString &name, const QString &value)
{
  QString name1 = name;
  if      (name1.left(14) == "CQChartsGeom::")
    name1 = "Geom" + name1.mid(14);
  ...
  metaObj_->setTypeStr(name1, value);
}
