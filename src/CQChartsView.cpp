...
{
  CQChartsEllipseAnnotation *annotation =
...
writeScript(const QString &filename, CQChartsPlot *plot)
{
  ...
  "  var u = u1/u2;\n"
  "\n"
  "  if      (u < 0.0) { return this.pixelPointPointDistance(px, py, px1, py1); }\n"
  "  else if (u > 1.0) { return this.pixelPointPointDistance(px, py, px2, py2); }\n"
  "  else              { return this.pixelPointPointDistance(px, py, px1 + u*dx1, py1 + u*dy1); }\n"
  "}\n"
  "\n"
