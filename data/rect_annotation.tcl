...
set vrectId1 [create_charts_rect_annotation -view $viewId -id rectId1 -tip "Rectangle 1" \
  -start {10 10} -end {50 50} \
  -filled 1 -fill_color blue -fill_alpha 0.5]

set rectId1 [create_charts_rect_annotation -plot $plotId -id rectId1 -tip "Rectangle 1" \
  -start {0 -60} -end {100 -40} \
  -filled 1 -fill_color red -fill_alpha 0.5]

set rectId2 [create_charts_rect_annotation -plot $plotId -id rectId2 -tip "Rectangle 2" \
  -start {0 -30} -end {100 -10} \
  -stroke_color green -stroke_alpha 0.5 -stroke_width 3 -corner_size 8]

set rectId3 [create_charts_rect_annotation -plot $plotId -id rectId3 -tip "Rectangle 3" \
