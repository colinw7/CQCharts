...
set vrectId1 [create_rect_annotation -view $viewId -id rectId1 -tip "Rectangle 1" \
  -start {10 10} -end {50 50} \
  -background 1 -background_color blue -background_alpha 0.5]

set rectId1 [create_rect_annotation -plot $plotId -id rectId1 -tip "Rectangle 1" \
  -start {0 -60} -end {100 -40} \
  -background 1 -background_color red -background_alpha 0.5]

set rectId2 [create_rect_annotation -plot $plotId -id rectId2 -tip "Rectangle 2" \
  -start {0 -30} -end {100 -10} \
  -border_color green -border_alpha 0.5 -border_width 3 -corner_size 8]

set rectId3 [create_rect_annotation -plot $plotId -id rectId3 -tip "Rectangle 3" \
