...
set globalProperties [qt_create_widget -type CQChartsGlobalPropertiesWidget -name globalProperties]

set globalPropertiesAnn [create_charts_widget_annotation -plot $plot -id globalProperties \
  -rectangle [list 1 50 99 99 V] -widget $globalProperties]

set globalProperties [get_charts_data -annotation $globalProperties -name widget_path]
