...
#set_theme -color_type defined -defined "0=#ffffff 1=#000000 2=#808080"
#set_theme -color_type defined -defined "0=#2a2a2a 1=#ffffff 2=#808080"
...
#set_property -view $view -plot $plot1 -name dataLabel.color            -value "theme:1"
#set_property -view $view -plot $plot1 -name plotStyle.fill.color       -value "theme:0"
#set_property -view $view -plot $plot1 -name dataStyle.fill.color       -value "theme:0"
...
#set_property -view $view -plot $plot1 -name "xaxis.label.color"       -value "theme:1"
#set_property -view $view -plot $plot1 -name "xaxis.ticks.label.color" -value "theme:1"
set_property -view $view -plot $plot1 -name "yaxis.grid.line.major.visible" -value 1
#set_property -view $view -plot $plot1 -name "yaxis.grid.line.major.color"   -value "theme:1"
#set_property -view $view -plot $plot1 -name "yaxis.label.color"       -value "theme:1"
#set_property -view $view -plot $plot1 -name "yaxis.ticks.label.color" -value "theme:1"
...
#set_property -view $view -plot $plot1 -name key.text.color             -value "theme:1"
set_property -view $view -plot $plot1 -name title.text.font            -value "FreeSans,18,-1,5,63,0,0,0,0,0"
#set_property -view $view -plot $plot1 -name title.text.color           -value "theme:1"
