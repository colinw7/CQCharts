...
set_charts_palette -palette default -name defined_colors -value [list "0=#6d78ad" "1=#51cda0" "2=#df7970"]
#set_charts_palette -palette default -name defined_colors -value [list "0=#4d81bc" "1=#c0504e" "2=#9bbb58"]
...
puts [lindex [split [lindex $colors 0] =] 1]
puts [lindex [split [lindex $colors 1] =] 1]
puts [lindex [split [lindex $colors 2] =] 1]
