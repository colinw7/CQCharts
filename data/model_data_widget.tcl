proc columnSelect { c } {
  qt_set_property -object $::modelDataWidget -property column -value $c
}
...
set modelDataWidget [qt_create_widget -type CQChartsModelDataWidget -name modelDataWidget]

set modelDataWidgetAnn [create_charts_widget_annotation -plot $plot -id modelDataWidget \
  -rectangle [list 1 50 99 99 V] -widget $modelDataWidget]

set modelDataWidget [get_charts_data -annotation $modelDataWidget -name widget_path]
