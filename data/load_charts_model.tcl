...
# max rows
set model2 [load_charts_model -csv data/diamonds.csv -first_line_header -max_rows 100]
...
# specific columns
set model3 [load_charts_model -csv data/diamonds.csv -first_line_header -columns {price clarity cut}]
