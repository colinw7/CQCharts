proc columnSelect { c } {
  qt_set_property -object $::modelFoldControl -property column -value $c
}
...
set modelFoldControl [qt_create_widget -type CQChartsModelFoldControl -name modelFoldControl]

set modelFoldControlAnn [create_charts_widget_annotation -plot $plot -id modelFoldControl \
  -rectangle [list 1 50 99 99 V] -widget $modelFoldControl]

set modelFoldControl [get_charts_data -annotation $modelFoldControl -name widget_path]
