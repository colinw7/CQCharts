...
set palette [create_charts_palette -palette red_green_1]

set_charts_palette -palette red_green_1 -name defined_colors -value {{0 red} {1 green}}

set colors [get_charts_palette -palette red_green_1 -name defined_colors]

set_charts_palette -theme theme3 -name palettes -value [list red_green_1]
...
set_charts_property -plot $plot -name coloring.defaultPalette -value red_green_1
