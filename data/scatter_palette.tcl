...
set_charts_palette -palette red_green -name defined_colors -value [list "0=red" "1=green"]
...
set plot [create_charts_plot -model $model -type scatter \
  -columns "x=sepalLength,y=sepalWidth" -properties "symbol.type=circle,symbol.size=5px"]
