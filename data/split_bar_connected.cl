...
set_property -view $view -name key.visible -value 1
...
set_property -view $view -plot $plot1 -name yaxis.side -value TOP_RIGHT
...
set_property -view $view -plot $plot2 -name yaxis.side -value TOP_RIGHT
...
set_property -view $view -plot $plot2 -name margin.left -value 0
