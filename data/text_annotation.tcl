...
set textAnnotationId1 [create_text_shape -plot $plotId -id one -x 0 -y -60 -text "One"]

set textAnnotationId2 [create_text_shape -plot $plotId -id two -x 0 -y -50 -text "Two" -color red]

set textAnnotationId3 [create_text_shape -plot $plotId -id three -x 0 -y -40 -text "Three" -color green -alpha 0.5]

set textAnnotationId4 [create_text_shape -plot $plotId -id four -x 0 -y -30 -text "Four"  -color blue  -angle 45]
