...
set plot [create_charts_plot -model $model -type distribution -columns "group=CST\[%B\],value=2" -title "Temperature Ridge Lines"]

set_charts_property -plot $plot -name density.enabled -value 1

#set plot [create_charts_plot -model $model -type distribution -columns "group=CST\[%B\],value=Mean Temperature \[F\]"]
