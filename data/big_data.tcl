...
#set plot1 [create_plot -type xy -columns "x=0,y=1" -title "XY (100000 Points)" -properties "lines.visible=0,points.visible=1"]
...
#place_plots -view $view -rows 2 -columns 3 $plots
