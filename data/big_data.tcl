...
#set plot1 [create_charts_plot -type xy -columns "x=0,y=1" -title "XY (100000 Points)" -properties "lines.visible=0,points.visible=1"]

#set_charts_property -plot $plot1 -name lines.visible -value 0

#set plot2 [create_charts_plot -type barchart -columns "name=0,value=1" -title "Barchart (100000 points)" -properties "stroke.visible=0"]
...
#set plot5 [create_charts_plot -type distribution -columns "value=1" -title "Distribution (100000 Points)"]
