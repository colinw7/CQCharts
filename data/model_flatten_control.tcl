proc columnSelect { c } {
  qt_set_property -object $::modelFlattenControl -property column -value $c
}
...
set modelFlattenControl [qt_create_widget -type CQChartsModelFlattenControl -name modelFlattenControl]

set modelFlattenControlAnn [create_charts_widget_annotation -plot $plot -id modelFlattenControl \
  -rectangle [list 1 50 99 99 V] -widget $modelFlattenControl]

set modelFlattenControl [get_charts_data -annotation $modelFlattenControl -name widget_path]
