proc createWidgets { } {
  ...
  set colorLabel "$view|$colorLabel"
  set scoreLabel "$view|$scoreLabel"
}
...
proc setMoveColor { color } {
  ...
  qt_set_property -object $colorLabel -property text -value $::moveColorText
}
...
proc setScore { } {
  ...
  qt_set_property -object $scoreLabel -property text -value $scoreText
}
