...
set model1 [load_model -tsv data/states.tsv -comment_header -column_type "1#polygon_list"]

set plot1 [create_plot -model $model1 -type geometry \
...
#set plot2 [create_plot -model $model2 -type geometry \
