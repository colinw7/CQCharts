...
create_ellipse_shape -plot $plotId -xc 0 -yc -60 -rx 50 -ry 50 \
  -background 1 -background_color red -background_alpha 0.5
ellipseId1 = _rc

create_ellipse_shape -plot $plotId -xc 0 -yc -30 -rx 50 -ry 30 \
  -border_color green -border_alpha 0.5 -border_width 3px
ellipseId2 = _rc

create_ellipse_shape -plot $plotId -xc 0 -yc   0 -rx 30 -ry 50 \
