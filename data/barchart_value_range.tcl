...
set plot [create_charts_plot -type barchart -model $model -columns {{group 0} {values {2 3}}} \
  -parameter {valueType RANGE} -parameter {orientation HORIZONTAL} \
  -properties {{dataLabel.visible 1}} \
