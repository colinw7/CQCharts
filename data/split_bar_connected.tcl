...
set_charts_property -plot $plotInd1 -name yaxis.side -value TOP_RIGHT
...
set_charts_property -plot $plotInd2 -name yaxis.side -value TOP_RIGHT
...
set_charts_property -plot $plotInd2 -name margins.outer.left -value 0
