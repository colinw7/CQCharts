...
set_property -plot $plotInd1 -name yaxis.side -value TOP_RIGHT
...
set_property -plot $plotInd2 -name yaxis.side -value TOP_RIGHT
...
set_property -plot $plotInd2 -name margin.left -value 0
