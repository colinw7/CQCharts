...
set plot [create_plot -model $stat_model -type boxplot -columns "min=1,lowerMedian=2,median=3,upperMedian=4,max=5,outliers=6" -properties "options.horizontal=1"]
