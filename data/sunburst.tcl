...
set model3 [load_model -tsv data/coffee.tsv -first_line_header -column_type "1#color"]

set plot3 [create_plot -model $model3 -type sunburst -columns "names=0,color=1" -title "coffee characteristics" -properties "options.multiRoot=1"]
