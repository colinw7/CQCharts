...
set_charts_property -plot $::plot -name hier.size -value 2em
...
set_charts_property -plot $::plot -name leaf.size -value 0.5em
...
set_charts_property -plot $::plot -name edge.width -value 0
