...
set palette [create_charts_palette -palette green_red]

set_charts_palette -palette green_red -name defined_colors -value [list {0 green} {1 red}]

set colors [get_charts_palette -palette green_red -name defined_colors]

set_charts_palette -theme theme3 -name palettes -value [list green_red]
...
set_charts_property -plot $plot -name coloring.defaultPalette -value green_red
