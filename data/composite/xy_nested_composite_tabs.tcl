...
set_charts_property -plot $plot1 -name state.name -value "New York"
set_charts_property -plot $plot2 -name state.name -value "San Francisco"
set_charts_property -plot $plot3 -name state.name -value "Austin"
...
set_charts_property -plot $plot4 -name state.name -value "New York"
set_charts_property -plot $plot5 -name state.name -value "San Francisco"
set_charts_property -plot $plot6 -name state.name -value "Austin"
