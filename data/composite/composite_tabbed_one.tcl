...
### graph
#set graph_model [load_charts_model -csv data/dot/dot_fsm.csv -first_line_header]
...
### xy
set xy_model [load_charts_model -tsv data/multi_series.tsv -comment_header \
  -column_type {{{time} {format %Y%m%d} {oformat %F}}}]

set xy_plot [create_charts_plot -type xy -columns {{x 0} {y 1}} -title "New York Temperatures"]

lappend plots $xy_plot
